...
// Regression for the dark-mode contrast bug: the group column headers and Submit
// must not render light-on-light (the bug was an un-overridden white --cs-card
// surface).
...
test('group headers and submit are legible in dark mode', async ({ page }) => {
  ...
  expect(channelSum(headerBg)).toBeLessThan(500);
